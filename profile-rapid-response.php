	...
	<div class="container">
		<div class="row">
			<div class="profile-page">
				<div class="col-md-6">
					<div class="tab-content profile-tabs-content" id="myTabContent">
						<div id="profile-pic1" class="tab-pane fade in active">
							<img src="images/swaleh_mohd_rro.jpg" alt="" />
						</div>
				...
				<div class="col-md-6">
					<h1><i class="icon-user"></i>Swaleh Mohammed</h1>
					<span class="designation">Rapid Response Officer</span>
					<ul class="profile-info">
						...
						<li>
							...
							<p>m.swaleh@kyaf.or.ke</p>
						</li>
						<li>
						
						</li>
					</ul>
					<p>Mr. Swaleh Mohamed is an experienced community social worker having worked with Coast Youth Development and Kenya Muslim Youth Alliance for over 10 years.
Mr. Swaleh Mohamed has been at the forefront of agitating for the rights of community members at the grassroots level in Mombasa and the Coast Region at large.
Mr. Swaleh Mohamed has political experience having served as a Ward Administrator for major political parties in Kenya.
Mr. Swaleh Mohamed is passionate about the community as well as highly knowledgeable about the terrain of Mombasa and Coast Region. 
Mr. Swaleh Mohamed is tasked with providing rapid response to emergency issues from the community and coordinating field work activities.
