	...
	<div class="container">
		<div class="row">
			<div class="profile-page">
				<div class="col-md-6">
					<div class="tab-content profile-tabs-content" id="myTabContent">
						<div id="profile-pic1" class="tab-pane fade in active">
							<img src="images/emily_achieng.jpg" alt="" />
						</div>
				...
				<div class="col-md-6">
					<h1><i class="icon-user"></i>Emily Achieng'</h1>
					<span class="designation">Programs Coordinator</span>
					<ul class="profile-info">
						...
						<li>
							...
							<p>a.emily@kyaf.or.ke</p>
						</li>
						<li>
						
						</li>
					</ul>
					<p>Ms. Emily Achieng is a project planning and management expert having acquired a Bachelor of Arts in Project Planning and Management and Masters of Project Planning and Management at the University of Nairobi; she is currently pursing a PhD in Project Planning and Management at the University of Nairobi.
Ms. Emily Achieng has previously worked as the Programs Officer at Strengthening Human Rights Defenders Voices, Breinscope Consultancy, and Afya Pwani Organization.
Ms. Emily Achieng has monitoring and evaluation experience having worked as an M&E Officer at Children and Youth In Distress Organization.
Ms. Emily Achieng is tasked with the coordination  of program activities at KYAF.
